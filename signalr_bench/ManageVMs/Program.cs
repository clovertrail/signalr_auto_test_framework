...
namespace ManageVMs
{
    class Program
    {
        public static void Main (string[] args)
        {
            ...
            var res = "";
            var cmd = "";
            var rndNum = "1185658706"; // TODO: only for debug
            ...
            for (int i = 0; i < argsOption.VmCount; i++)
            {
                ...
                cmd = $"echo '{argsOption.VmPassWord}' | sudo -S bash -c \" echo 'wanl    soft    nofile  655350' >> /etc/security/limits.conf\"";
            ...
            swConfig.Stop();
            Console.WriteLine($"config elapsed time: {swConfig.Elapsed.TotalMinutes}");
        }
