    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            cfg.Slaves.ForEach(host =>
            {
                ...
                cmd = $"cd /home/{cfg.User}/signalr_auto_test_framework/signalr_bench/Rpc/Bench.Server/; dotnet run -a '{argsOption.AgentConfigFile}' -d 0.0.0.0 -x '{argsOption.AgentBlobName}' -y '{argsOption.JobBlobName}' > log.txt";
                Util.Log($"CMD: {cfg.User}@{host}: {cmd}");
            ...
            cmd = $"cd /home/{cfg.User}/signalr_auto_test_framework/signalr_bench/Rpc/Bench.Client/; dotnet run -a '{argsOption.AgentConfigFile}' -j '{argsOption.JobConfigFile}'  -x '{argsOption.AgentBlobName}' -y '{argsOption.JobBlobName}' > log.txt";
